...
- Página 3: Mensalidades UNIMED Retroativas (tabela: nome, código cartão, valor)
- Página 4: Mensalidades UNIMED (tabela: nome, código cartão, valor)
- Página 5: Mensalidade UNIODONTO (tabela: nome, CPF, valor)
- Página 6: Mensalidade UNIMED BH (tabela: nome, CPF, valor)
"""

PAGE_WIDTH = 595.28
PAGE_HEIGHT = 841.89

# Índice de páginas por tipo (0-based)
PAGE_RESUMO = 0
PAGE_CONSULTAS = 1
...
# Cabeçalho base — posições para sobrescrever
HEADER = {
...
# Página 1 — Resumo: tabela convênio / valor (até 4 linhas + total)
RESUMO = {
    "header_y": 290.00,
    "row_height": 22.0,
    "first_row_y": 312.00,
...
# Página 5 — Unimed BH: nome, CPF, valor
UNIMED_BH = {
    "header_y": 290.00,
    "row_height": 22.0,
    "first_row_y": 312.00,
